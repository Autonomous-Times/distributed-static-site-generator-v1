...
#[marine]
pub fn insert(content: TuContentItem, table: TuDsgTable, gateway: String) -> AquaMarineResult {
...
#[marine]
pub fn batch_insert(content: crate::TuContentItem, table: TuDsgTable) -> AquaMarineResult {
...
#[marine]
pub fn queryCollectionCids(collection: TuDsgCollection, table: TuDsgTable) -> AquaMarineResult {
